...
namespace SwipeMenu
{
	...
	public class Menu : MonoBehaviour
	{
        ...
        public void UpdateMenuItems(int startingMenuItem)
        {
            this.startingMenuItem = startingMenuItem;
		...
		{
            return Mathf.Abs(item.transform.position.x) < 0.01f;
		}
		...
		private void UpdateMenuItemsPositionInWorldSpace ()
		{
			for (int i = 0; i < menuItems.Length; i++) {
                ...
                Vector3 pos = new Vector3 (posx, menuItems[i].transform.position.y, posz);
