...
public class Music : MonoBehaviour
{
    ...
    public enum Type { None, MainMusic1, MainMusic2 };
    ...
    {
        instance = this;
        selectMusicIndex = Random.Range(0, 2);
    }
    ...
    {
        if (Time.time - lastChangeTime > 90)
        {
            Type[] types = { Type.MainMusic1, Type.MainMusic2 };
            Play(types[selectMusicIndex]);
            selectMusicIndex = (selectMusicIndex + 1) % types.Length;
